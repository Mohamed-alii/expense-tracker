...
const INTIAL_EXPENSE = [
  {title:'book' , date:new Date(2020 , 1 , 28) , amount:416 , id:1},
  {title:'wallet' , date:new Date(2020 , 5 , 2) , amount:123 , id:3},
  {title:'drinks' , date:new Date(2019 , 10 , 13) , amount:743 , id:5},
  {title:'food' , date:new Date(2020 , 9 , 20) , amount:2000 , id:2}
]
